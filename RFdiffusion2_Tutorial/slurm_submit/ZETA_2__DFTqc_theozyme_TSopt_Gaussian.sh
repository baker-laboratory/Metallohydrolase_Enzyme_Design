...
#SBATCH --output=/path/to/Metallohydrolase_Enzyme_Design/RFdiffusion2_Tutorial/logs/slurm_%j.out
#SBATCH --error=/path/to/Metallohydrolase_Enzyme_Design/RFdiffusion2_Tutorial/logs/slurm_%j.err
#SBATCH --mail-type=END
#SBATCH --mail-user=EXAMPLE_EMAIL@uw.edu
#SBATCH --chdir=/path/to/Metallohydrolase_Enzyme_Design/RFdiffusion2_Tutorial/theozymes/from_quantum_chemistry/Gaussian_TSopt
